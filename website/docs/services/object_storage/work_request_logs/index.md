...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.object_storage.work_request_logs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The date and time the log message was written, as described in &#91;RFC 3339&#93;(https:​//tools.ietf.org/html/rfc3339). </td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Lists the logs of the work request with the given ID.</td>
</tr>
</tbody>
</table>
...
message,
timestamp
FROM oci.object_storage.work_request_logs
