...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.object_storage.work_request_errors" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A machine-usable code for the error that occurred. For the list of error codes, see &#91;API Errors&#93;(/Content/API/References/apierrors.htm). </td>
</tr>
<tr>
    <td><CopyableCode code="message" /></td>
    <td><code>string</code></td>
    <td>A human-readable description of the issue that produced the error.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Lists the errors of the work request with the given ID.</td>
</tr>
</tbody>
</table>
...
message,
timestamp
FROM oci.object_storage.work_request_errors
