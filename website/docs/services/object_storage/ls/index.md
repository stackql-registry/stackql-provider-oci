...
Creates, updates, deletes, gets or lists a <code>ls</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="ls" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.object_storage.ls" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#put_object_lifecycle_policy"><CopyableCode code="put_object_lifecycle_policy" /></a></td>
    ...
    <td><a href="#parameter-opc-client-request-id"><code>opc-client-request-id</code></a>, <a href="#parameter-if-match"><code>if-match</code></a>, <a href="#parameter-if-none-match"><code>if-none-match</code></a></td>
    <td>Creates or replaces the object lifecycle policy for the bucket.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="put_object_lifecycle_policy"
    values={[
        { label: 'put_object_lifecycle_policy', value: 'put_object_lifecycle_policy' }
    ]}
>
<TabItem value="put_object_lifecycle_policy">

Creates or replaces the object lifecycle policy for the bucket.&lt;br /&gt;

```sql
EXEC oci.object_storage.ls.put_object_lifecycle_policy 
