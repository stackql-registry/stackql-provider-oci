...
Creates, updates, deletes, gets or lists a <code>volume_group_replicas</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="volume_group_replicas" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.block_storage.volume_group_replicas" /></td></tr>
</tbody></table>
...
The volume group replica was retrieved.
...
<tr>
    ...
    <td>The OCID for the volume group replica.</td>
</tr>
<tr>
    <td><CopyableCode code="availabilityDomain" /></td>
    <td><code>string</code></td>
    <td>The availability domain of the volume group replica.</td>
</tr>
<tr>
    <td><CopyableCode code="compartmentId" /></td>
    <td><code>string</code></td>
    <td>The OCID of the compartment that contains the volume group replica.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The current state of a volume group. (PROVISIONING, AVAILABLE, ACTIVATING, TERMINATING, TERMINATED, FAULTY)</td>
</tr>
<tr>
    <td><CopyableCode code="memberReplicas" /></td>
    <td><code>array</code></td>
    <td>Volume replicas within this volume group replica.</td>
</tr>
<tr>
    <td><CopyableCode code="sizeInGBs" /></td>
    <td><code>integer (int64)</code></td>
    <td>The aggregate size of the volume group replica in GBs.</td>
</tr>
<tr>
    <td><CopyableCode code="timeCreated" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date and time the volume group replica was created. Format defined by &#91;RFC3339&#93;(https:​//tools.ietf.org/html/rfc3339).</td>
</tr>
<tr>
    <td><CopyableCode code="timeLastSynced" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date and time the volume group replica was last synced from the source volume group. Format defined by &#91;RFC3339&#93;(https:​//tools.ietf.org/html/rfc3339). </td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-volumeGroupReplicaId"><code>volumeGroupReplicaId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td></td>
    <td>Gets information for the specified volume group replica.</td>
</tr>
<tr>
    ...
    <td>Lists the volume group replicas in the specified compartment. You can filter the results by volume group.&lt;br /&gt;For more information, see &#91;Volume Group Replication&#93;(/iaas/Content/Block/Concepts/volumegroupreplication.htm).&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-volumeGroupReplicaId">
    <td><CopyableCode code="volumeGroupReplicaId" /></td>
    <td><code>string</code></td>
    <td>The OCID of the volume replica group.</td>
</tr>
...
timeLastSynced,
volumeGroupId
FROM oci.block_storage.volume_group_replicas
WHERE volumeGroupReplicaId = '{{ volumeGroupReplicaId }}' -- required
...
Lists the volume group replicas in the specified compartment. You can filter the results by volume group.&lt;br /&gt;For more information, see &#91;Volume Group Replication&#93;(/iaas/Content/Block/Concepts/volumegroupreplication.htm).&lt;br /&gt;
