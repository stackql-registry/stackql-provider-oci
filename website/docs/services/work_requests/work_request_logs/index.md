...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.work_requests.work_request_logs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The date and time the log message was written.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Gets the logs for a work request.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Gets the logs for a work request.&lt;br /&gt;

```sql
SELECT
message,
timestamp
FROM oci.work_requests.work_request_logs
