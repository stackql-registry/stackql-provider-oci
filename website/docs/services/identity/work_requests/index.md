...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.identity.work_requests" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The errors for work request. </td>
</tr>
<tr>
    <td><CopyableCode code="logs" /></td>
    <td><code>array</code></td>
    <td>The logs for work request. </td>
</tr>
<tr>
    <td><CopyableCode code="operationType" /></td>
    <td><code>string</code></td>
    <td>An enum-like description of the type of work the work request is doing. (DELETE_COMPARTMENT, DELETE_TAG_DEFINITION)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The current status of the work request. (ACCEPTED, IN_PROGRESS, FAILED, SUCCEEDED, CANCELING, CANCELED)</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Gets details on a specified work request. The workRequestID is returned in the opc-work-request-id header&lt;br /&gt;for any asynchronous operation in the compartment service.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Lists the work requests in compartment.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Gets details on a specified work request. The workRequestID is returned in the opc-work-request-id header&lt;br /&gt;for any asynchronous operation in the compartment service.&lt;br /&gt;
...
timeFinished,
timeStarted
FROM oci.identity.work_requests
...
Lists the work requests in compartment.&lt;br /&gt;
