--- 
title: autonomous_exadata_infrastructure_shapes
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>autonomous_exadata_infrastructure_shapes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="autonomous_exadata_infrastructure_shapes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.database.autonomous_exadata_infrastructure_shapes" /></td></tr>
</tbody></table>
...
The shape of the Autonomous Exadata Infrastructure. The shape determines resources to allocate to the Autonomous Exadata Infrastructure (CPU cores, memory and storage).&lt;br /&gt;&lt;br /&gt;To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator.&lt;br /&gt;If you're an administrator who needs to write policies to give users access,&lt;br /&gt;see &#91;Getting Started with Policies&#93;(/Content/Identity/Concepts/policygetstarted.htm).&lt;br /&gt;
...
<tr>
    ...
    <td>The name of the shape used for the Autonomous Exadata Infrastructure.</td>
</tr>
<tr>
    <td><CopyableCode code="availableCoreCount" /></td>
    <td><code>integer</code></td>
    <td>The maximum number of CPU cores that can be enabled on the Autonomous Exadata Infrastructure.</td>
</tr>
<tr>
    <td><CopyableCode code="coreCountIncrement" /></td>
    <td><code>integer</code></td>
    <td>The increment in which core count can be increased or decreased.</td>
</tr>
<tr>
    <td><CopyableCode code="maximumNodeCount" /></td>
    <td><code>integer</code></td>
    <td>The maximum number of nodes available for the shape.</td>
</tr>
<tr>
    <td><CopyableCode code="minimumCoreCount" /></td>
    <td><code>integer</code></td>
    <td>The minimum number of CPU cores that can be enabled on the Autonomous Exadata Infrastructure.</td>
</tr>
<tr>
    <td><CopyableCode code="minimumNodeCount" /></td>
    <td><code>integer</code></td>
    <td>The minimum number of nodes available for the shape.</td>
</tr>
<tr>
...
FROM oci.database.autonomous_exadata_infrastructure_shapes
