...
Creates, updates, deletes, gets or lists a <code>console_histories</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="console_histories" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.database.console_histories" /></td></tr>
</tbody></table>
...
The console history information was retrieved.
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The OCID of the compartment containing the console history.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The user-friendly name for the console history. The name does not need to be unique.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The current state of the console history. (REQUESTED, GETTING_HISTORY, SUCCEEDED, FAILED, DELETED, DELETING)</td>
</tr>
<tr>
    <td><CopyableCode code="timeCreated" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date and time the console history was created.</td>
</tr>
</tbody>
</table>
</TabItem>
...
The list of console histories was retrieved.
...
<tr>
    ...
    <td><a href="#parameter-dbNodeId"><code>dbNodeId</code></a>, <a href="#parameter-consoleHistoryId"><code>consoleHistoryId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-opc-request-id"><code>opc-request-id</code></a></td>
    <td>Gets information about the specified database node console history.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Lists the console histories for the specified database node.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-dbNodeId"><code>dbNodeId</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-displayName"><code>displayName</code></a></td>
    ...
    <td>Captures the most recent serial console data (up to a megabyte) for the specified database node.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Updates the specified database node console history.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dbNodeId"><code>dbNodeId</code></a>, <a href="#parameter-consoleHistoryId"><code>consoleHistoryId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-if-match"><code>if-match</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a></td>
    <td>Deletes the specified database node console history.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-consoleHistoryId">
    <td><CopyableCode code="consoleHistoryId" /></td>
    <td><code>string</code></td>
    <td>The OCID of the console history.</td>
</tr>
...
Gets information about the specified database node console history.&lt;br /&gt;
...
lifecycleState,
timeCreated
FROM oci.database.console_histories
WHERE dbNodeId = '{{ dbNodeId }}' -- required
AND consoleHistoryId = '{{ consoleHistoryId }}' -- required
...
Lists the console histories for the specified database node.&lt;br /&gt;
...
Captures the most recent serial console data (up to a megabyte) for the specified database node.&lt;br /&gt;

```sql
INSERT INTO oci.database.console_histories (
definedTags,
displayName,
freeformTags,
dbNodeId,
...
- name: console_histories
  props:
    - name: dbNodeId
      value: "{{ dbNodeId }}"
      description: Required parameter for the console_histories resource.
    - name: region
      value: "{{ region }}"
      description: Required parameter for the console_histories resource.
    - name: definedTags
...
Updates the specified database node console history.&lt;br /&gt;

```sql
UPDATE oci.database.console_histories
SET 
...
Deletes the specified database node console history.&lt;br /&gt;

```sql
DELETE FROM oci.database.console_histories
WHERE dbNodeId = '{{ dbNodeId }}' --required
AND consoleHistoryId = '{{ consoleHistoryId }}' --required
AND region = '{{ region }}' --required
AND if-match = '{{ if-match }}'
