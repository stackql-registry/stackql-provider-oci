...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.database.autonomous_database_peers" /></td></tr>
</tbody></table>
...
The list of Autonomous AI Database peers for the specified Autonomous AI Database was retrieved.
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The name of the region where this peer Autonomous AI Database clone exists.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Lists the Autonomous AI Database peers for the specified Autonomous AI Database.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Lists the Autonomous AI Database peers for the specified Autonomous AI Database.&lt;br /&gt;

```sql
SELECT
id,
region
FROM oci.database.autonomous_database_peers
