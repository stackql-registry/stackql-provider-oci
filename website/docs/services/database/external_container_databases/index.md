--- 
title: external_container_databases
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>external_container_databases</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="external_container_databases" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.database.external_container_databases" /></td></tr>
</tbody></table>
...
The external container database.
...
An Oracle Cloud Infrastructure resource that allows you to manage an external Oracle container database.&lt;br /&gt;
...
<tr>
    ...
    <td>Gets information about the specified external container database.</td>
</tr>
<tr>
    ...
    <td>Gets a list of the external container databases in the specified compartment.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Creates a new external container database resource.</td>
</tr>
<tr>
    <td><a href="#update"><CopyableCode code="update" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-externalContainerDatabaseId"><code>externalContainerDatabaseId</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-displayName"><code>displayName</code></a></td>
    <td><a href="#parameter-if-match"><code>if-match</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a></td>
    <td>Updates the properties of&lt;br /&gt;an &#91;ExternalContainerDatabase&#93;(#/en/database/latest/datatypes/CreateExternalContainerDatabaseDetails) resource,&lt;br /&gt;such as the display name.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Deletes the &#91;external container database&#93;(#/en/database/latest/datatypes/CreateExternalContainerDatabaseDetails)&lt;br /&gt;resource. Any external pluggable databases registered under this container database must be deleted in&lt;br /&gt;your Oracle Cloud Infrastructure tenancy prior to this operation.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#change_compartment"><CopyableCode code="change_compartment" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-externalContainerDatabaseId"><code>externalContainerDatabaseId</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-compartmentId"><code>compartmentId</code></a></td>
    ...
    <td>Move the &#91;external container database&#93;(#/en/database/latest/datatypes/CreateExternalContainerDatabaseDetails)&lt;br /&gt;and its dependent resources to the specified compartment.&lt;br /&gt;For more information about moving external container databases, see&lt;br /&gt;&#91;Moving Database Resources to a Different Compartment&#93;(/Content/Database/Concepts/databaseoverview.htm#moveRes).&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
timeCreated,
timeZone
FROM oci.database.external_container_databases
WHERE externalContainerDatabaseId = '{{ externalContainerDatabaseId }}' -- required
...
Gets a list of the external container databases in the specified compartment.&lt;br /&gt;
...
```sql
INSERT INTO oci.database.external_container_databases (
compartmentId,
definedTags,
displayName,
freeformTags,
...
- name: external_container_databases
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the external_container_databases resource.
    - name: compartmentId
      value: "{{ compartmentId }}"
      description: |
...
Updates the properties of&lt;br /&gt;an &#91;ExternalContainerDatabase&#93;(#/en/database/latest/datatypes/CreateExternalContainerDatabaseDetails) resource,&lt;br /&gt;such as the display name.&lt;br /&gt;

```sql
UPDATE oci.database.external_container_databases
SET 
...
Deletes the &#91;external container database&#93;(#/en/database/latest/datatypes/CreateExternalContainerDatabaseDetails)&lt;br /&gt;resource. Any external pluggable databases registered under this container database must be deleted in&lt;br /&gt;your Oracle Cloud Infrastructure tenancy prior to this operation.&lt;br /&gt;

```sql
DELETE FROM oci.database.external_container_databases
WHERE externalContainerDatabaseId = '{{ externalContainerDatabaseId }}' --required
AND region = '{{ region }}' --required
AND opc-request-id = '{{ opc-request-id }}'
AND if-match = '{{ if-match }}'
...
Move the &#91;external container database&#93;(#/en/database/latest/datatypes/CreateExternalContainerDatabaseDetails)&lt;br /&gt;and its dependent resources to the specified compartment.&lt;br /&gt;For more information about moving external container databases, see&lt;br /&gt;&#91;Moving Database Resources to a Different Compartment&#93;(/Content/Database/Concepts/databaseoverview.htm#moveRes).&lt;br /&gt;

```sql
EXEC oci.database.external_container_databases.change_compartment 
@externalContainerDatabaseId='{{ externalContainerDatabaseId }}' --required, 
