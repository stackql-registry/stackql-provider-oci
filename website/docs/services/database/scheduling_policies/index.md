...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.database.scheduling_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The cadence period. (HALFYEARLY, QUARTERLY, MONTHLY)</td>
</tr>
<tr>
    <td><CopyableCode code="cadenceStartMonth" /></td>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The user-friendly name for the Scheduling Policy. The name does not need to be unique.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The current state of the Scheduling Policy. Valid states are CREATING, NEEDS_ATTENTION, ACTIVE, UPDATING, FAILED, DELETING and DELETED.  (CREATING, NEEDS_ATTENTION, AVAILABLE, UPDATING, FAILED, DELETING, DELETED)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>The date and time the Scheduling Policy was created.</td>
</tr>
<tr>
    <td><CopyableCode code="timeNextWindowStarts" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date and time of the next scheduling window associated with the schedulingPolicy is planned to start.</td>
</tr>
<tr>
    <td><CopyableCode code="timeUpdated" /></td>
    <td><code>string (date-time)</code></td>
    <td>The last date and time that the Scheduling Policy was updated.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Gets information about the specified Scheduling Policy.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#list"><CopyableCode code="list" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-compartmentId"><code>compartmentId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-page"><code>page</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a>, <a href="#parameter-sortBy"><code>sortBy</code></a>, <a href="#parameter-sortOrder"><code>sortOrder</code></a>, <a href="#parameter-lifecycleState"><code>lifecycleState</code></a>, <a href="#parameter-displayName"><code>displayName</code></a>, <a href="#parameter-cadence"><code>cadence</code></a></td>
    <td>Lists the Scheduling Policy resources in the specified compartment.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-compartmentId"><code>compartmentId</code></a>, <a href="#parameter-displayName"><code>displayName</code></a>, <a href="#parameter-cadence"><code>cadence</code></a></td>
    ...
    <td>Creates a Scheduling Policy resource.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Updates the Scheduling Policy resource.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-schedulingPolicyId"><code>schedulingPolicyId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-if-match"><code>if-match</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a></td>
    <td>Deletes the scheduling policy.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#change_compartment"><CopyableCode code="change_compartment" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-schedulingPolicyId"><code>schedulingPolicyId</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-compartmentId"><code>compartmentId</code></a></td>
    ...
    <td>Moves an scheduling policy resource to another compartment.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-cadence">
    <td><CopyableCode code="cadence" /></td>
    <td><code>string</code></td>
    <td>A filter to return only resources that match the given cadence period exactly.</td>
</tr>
...
Gets information about the specified Scheduling Policy.&lt;br /&gt;
...
timeUpdated
FROM oci.database.scheduling_policies
...
Lists the Scheduling Policy resources in the specified compartment.&lt;br /&gt;
...
Creates a Scheduling Policy resource.&lt;br /&gt;

```sql
INSERT INTO oci.database.scheduling_policies (
cadence,
cadenceStartMonth,
compartmentId,
definedTags,
...
- name: scheduling_policies
  props:
    ...
    - name: cadence
      ...
      description: |
        The cadence period.
      valid_values: ['HALFYEARLY', 'QUARTERLY', 'MONTHLY']
...
Updates the Scheduling Policy resource.&lt;br /&gt;

```sql
UPDATE oci.database.scheduling_policies
SET 
cadence = '{{ cadence }}',
...
Deletes the scheduling policy.&lt;br /&gt;

```sql
DELETE FROM oci.database.scheduling_policies
WHERE schedulingPolicyId = '{{ schedulingPolicyId }}' --required
AND region = '{{ region }}' --required
AND if-match = '{{ if-match }}'
AND opc-request-id = '{{ opc-request-id }}'
...
Moves an scheduling policy resource to another compartment.&lt;br /&gt;

```sql
EXEC oci.database.scheduling_policies.change_compartment 
@schedulingPolicyId='{{ schedulingPolicyId }}' --required, 
