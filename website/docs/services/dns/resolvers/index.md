...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.dns.resolvers" /></td></tr>
</tbody></table>
...
A Response containing a single resolver object.
...
<tr>
    ...
    <td>The OCID of the resolver.</td>
</tr>
<tr>
    <td><CopyableCode code="attachedVcnId" /></td>
    <td><code>string</code></td>
    <td>The OCID of the attached VCN. </td>
</tr>
<tr>
    <td><CopyableCode code="attachedViews" /></td>
    <td><code>array</code></td>
    <td>The attached views. Views are evaluated in order.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="defaultViewId" /></td>
    <td><code>string</code></td>
    <td>The OCID of the default view. </td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The display name of the resolver.  (x-default-description: This field will be set to a value in the format "dnsresolver&lt;currentTimestampUTC&gt;" where currentTimestampUTC&lt;br /&gt;is in ISO 8601 basic format "yyyyMMddHHmmss".&lt;br /&gt;)</td>
</tr>
<tr>
    <td><CopyableCode code="endpoints" /></td>
    <td><code>array</code></td>
    <td>Read-only array of endpoints for the resolver. </td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>array</code></td>
    <td>Rules for the resolver. Rules are evaluated in order, and only the first matching rule will have its action applied. </td>
</tr>
<tr>
...
An OCI DNS resolver. If the resolver has an attached VCN, the VCN will attempt to answer queries based on the&lt;br /&gt;attached views in priority order. If the query does not match any of the attached views, the query will be&lt;br /&gt;evaluated against the default view. If the default view does not match, the rules will be evaluated in&lt;br /&gt;priority order. If no rules match the query, answers come from Internet DNS. A resolver may have a maximum of 10&lt;br /&gt;resolver endpoints.&lt;br /&gt;&lt;br /&gt;**Warning:** Oracle recommends that you avoid using any confidential information when you supply string values using the API.&lt;br /&gt;
...
<tr>
    ...
    <td>Gets information about a specific resolver.&lt;br /&gt;&lt;br /&gt;Note that attempting to get a resolver in the DELETED lifecycleState will result in a `404`&lt;br /&gt;response to be consistent with other operations of the API.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Gets a list of all resolvers within a compartment.&lt;br /&gt;&lt;br /&gt;The collection can be filtered by display name, id, or lifecycle state. It can be sorted&lt;br /&gt;on creation time or displayName both in ASC or DESC order. Note that when no lifecycleState&lt;br /&gt;query parameter is provided, the collection does not include resolvers in the DELETED&lt;br /&gt;lifecycleState to be consistent with other operations of the API.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Updates the specified resolver with your new information.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#change_compartment"><CopyableCode code="change_compartment" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-resolverId"><code>resolverId</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-compartmentId"><code>compartmentId</code></a></td>
    ...
    <td>Moves a resolver into a different compartment along with its protected default view and any endpoints.&lt;br /&gt;&lt;br /&gt;Zones in the default view are not moved. VCN-dedicated resolvers are initially created in the same compartment&lt;br /&gt;as their corresponding VCN, but can then be moved to a different compartment.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-sortBy">
    ...
    <td><code>string</code></td>
    <td>The field by which to sort resolvers.</td>
</tr>
...
Gets information about a specific resolver.&lt;br /&gt;&lt;br /&gt;Note that attempting to get a resolver in the DELETED lifecycleState will result in a `404`&lt;br /&gt;response to be consistent with other operations of the API.&lt;br /&gt;
...
Gets a list of all resolvers within a compartment.&lt;br /&gt;&lt;br /&gt;The collection can be filtered by display name, id, or lifecycle state. It can be sorted&lt;br /&gt;on creation time or displayName both in ASC or DESC order. Note that when no lifecycleState&lt;br /&gt;query parameter is provided, the collection does not include resolvers in the DELETED&lt;br /&gt;lifecycleState to be consistent with other operations of the API.&lt;br /&gt;
...
Updates the specified resolver with your new information.&lt;br /&gt;

```sql
UPDATE oci.dns.resolvers
SET 
...
Moves a resolver into a different compartment along with its protected default view and any endpoints.&lt;br /&gt;&lt;br /&gt;Zones in the default view are not moved. VCN-dedicated resolvers are initially created in the same compartment&lt;br /&gt;as their corresponding VCN, but can then be moved to a different compartment.&lt;br /&gt;

```sql
EXEC oci.dns.resolvers.change_compartment 
@resolverId='{{ resolverId }}' --required, 
