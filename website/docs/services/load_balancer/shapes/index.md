...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.load_balancer.shapes" /></td></tr>
</tbody></table>
...
A shape is a template that determines the total pre-provisioned bandwidth (ingress plus egress) for the&lt;br /&gt;load balancer.&lt;br /&gt;&lt;br /&gt;Note that the pre-provisioned maximum capacity applies to aggregated connections, not to a single client&lt;br /&gt;attempting to use the full bandwidth.&lt;br /&gt;
...
<tr>
    ...
    <td>The name of the shape.  Example: `100Mbps` </td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Lists the valid load balancer shapes.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-compartmentId">
    ...
    <td><code>string</code></td>
    <td>The &#91;OCID&#93;(/Content/General/Concepts/identifiers.htm) of the compartment containing the load balancer shapes to list.</td>
</tr>
