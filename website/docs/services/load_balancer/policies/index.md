...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.load_balancer.policies" /></td></tr>
</tbody></table>
...
A policy that determines how traffic is distributed among backend servers.&lt;br /&gt;For more information on load balancing policies, see&lt;br /&gt;&#91;How Load Balancing Policies Work&#93;(/Content/Balance/Reference/lbpolicies.htm).&lt;br /&gt;
...
<tr>
    ...
    <td>The name of a load balancing policy.  Example: 'LEAST_CONNECTIONS' </td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Lists the available load balancer policies.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-compartmentId">
    ...
    <td><code>string</code></td>
    <td>The &#91;OCID&#93;(/Content/General/Concepts/identifiers.htm) of the compartment containing the load balancer policies to list.</td>
</tr>
...
SELECT
name
FROM oci.load_balancer.policies
