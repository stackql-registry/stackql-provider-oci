...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.logging.work_request_errors" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>A machine-usable code for the error that occured. Error codes are listed at https:​//docs.us-phoenix-1.oraclecloud.com/Content/API/References/apierrors.htm. </td>
</tr>
<tr>
    <td><CopyableCode code="message" /></td>
    <td><code>string</code></td>
    <td>A human readable description of the issue encountered.</td>
</tr>
<tr>
    <td><CopyableCode code="timestamp" /></td>
    <td><code>string (date-time)</code></td>
    <td>The time the error occured. An RFC3339-formatted date and time string.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Return a list of errors for a given work request.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Return a list of errors for a given work request.&lt;br /&gt;
...
message,
timestamp
FROM oci.logging.work_request_errors
