...
Creates, updates, deletes, gets or lists a <code>log_saved_searches</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="log_saved_searches" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.logging.log_saved_searches" /></td></tr>
</tbody></table>
...
Successfully retrieved LogSavedSearch.
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The state of the LogSavedSearch  (CREATING, ACTIVE, UPDATING, INACTIVE, DELETING, FAILED) (x-obmcs-top-level-enum: #/definitions/LogSavedSearchLifecycleState)</td>
</tr>
<tr>
    <td><CopyableCode code="query" /></td>
    <td><code>string</code></td>
    <td>The search query that is saved. </td>
</tr>
<tr>
...
Successfully retrieved list of LogSavedSearch summary entities.
...
<tr>
    ...
    <td><a href="#parameter-logSavedSearchId"><code>logSavedSearchId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-opc-request-id"><code>opc-request-id</code></a></td>
    <td>Retrieves a LogSavedSearch.</td>
</tr>
<tr>
    <td><a href="#list"><CopyableCode code="list" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-compartmentId"><code>compartmentId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-logSavedSearchId"><code>logSavedSearchId</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-page"><code>page</code></a>, <a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-sortBy"><code>sortBy</code></a>, <a href="#parameter-sortOrder"><code>sortOrder</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a></td>
    <td>Lists LogSavedSearches for this compartment.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-region"><code>region</code></a>, <a href="#parameter-compartmentId"><code>compartmentId</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-query"><code>query</code></a></td>
    ...
    <td>Creates a new LogSavedSearch.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Updates an  existing LogSavedSearch.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-logSavedSearchId"><code>logSavedSearchId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-if-match"><code>if-match</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a></td>
    <td>Deletes the specified LogSavedSearch.</td>
</tr>
<tr>
    <td><a href="#change_compartment"><CopyableCode code="change_compartment" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-logSavedSearchId"><code>logSavedSearchId</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-compartmentId"><code>compartmentId</code></a></td>
    ...
    <td>Moves a saved search into a different compartment within the same tenancy. For information about moving&lt;br /&gt;resources between compartments, see &#91;Moving Resources to a Different Compartment&#93;(/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes).&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-logSavedSearchId">
    <td><CopyableCode code="logSavedSearchId" /></td>
    <td><code>string</code></td>
    <td>OCID of the logSavedSearch. </td>
</tr>
...
timeCreated,
timeLastModified
FROM oci.logging.log_saved_searches
WHERE logSavedSearchId = '{{ logSavedSearchId }}' -- required
...
Lists LogSavedSearches for this compartment.&lt;br /&gt;
...
AND region = '{{ region }}' -- required
AND logSavedSearchId = '{{ logSavedSearchId }}'
AND name = '{{ name }}'
AND page = '{{ page }}'
AND limit = '{{ limit }}'
AND sortBy = '{{ sortBy }}'
...
Creates a new LogSavedSearch.&lt;br /&gt;

```sql
INSERT INTO oci.logging.log_saved_searches (
compartmentId,
definedTags,
description,
freeformTags,
...
- name: log_saved_searches
  props:
    - name: region
      value: "{{ region }}"
      description: Required parameter for the log_saved_searches resource.
    - name: compartmentId
      value: "{{ compartmentId }}"
      description: |
...
Updates an  existing LogSavedSearch.&lt;br /&gt;

```sql
UPDATE oci.logging.log_saved_searches
SET 
...
query = '{{ query }}'
WHERE 
logSavedSearchId = '{{ logSavedSearchId }}' --required
AND region = '{{ region }}' --required
...
```sql
DELETE FROM oci.logging.log_saved_searches
WHERE logSavedSearchId = '{{ logSavedSearchId }}' --required
AND region = '{{ region }}' --required
AND if-match = '{{ if-match }}'
AND opc-request-id = '{{ opc-request-id }}'
...
Moves a saved search into a different compartment within the same tenancy. For information about moving&lt;br /&gt;resources between compartments, see &#91;Moving Resources to a Different Compartment&#93;(/iaas/Content/Identity/Tasks/managingcompartments.htm#moveRes).&lt;br /&gt;

```sql
EXEC oci.logging.log_saved_searches.change_compartment 
@logSavedSearchId='{{ logSavedSearchId }}' --required, 
