...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.logging.work_request_logs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Human-readable log message.</td>
</tr>
<tr>
    <td><CopyableCode code="timestamp" /></td>
    <td><code>string (date-time)</code></td>
    <td>The time the log message was written. An RFC3339-formatted date and time string.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>Return a list of logs for a given work request.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Return a list of logs for a given work request.&lt;br /&gt;

```sql
SELECT
message,
timestamp
FROM oci.logging.work_request_logs
