--- 
title: compute_capacity_reservation_instance_shapes
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>compute_capacity_reservation_instance_shapes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="compute_capacity_reservation_instance_shapes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.compute.compute_capacity_reservation_instance_shapes" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The name of the available shape used to launch instances in a compute capacity reservation. </td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-availabilityDomain"><code>availabilityDomain</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a>, <a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-page"><code>page</code></a>, <a href="#parameter-displayName"><code>displayName</code></a>, <a href="#parameter-sortBy"><code>sortBy</code></a>, <a href="#parameter-sortOrder"><code>sortOrder</code></a></td>
    <td>Lists the shapes that can be reserved within the specified compartment.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Lists the shapes that can be reserved within the specified compartment.&lt;br /&gt;

```sql
SELECT
availabilityDomain,
instanceShape
FROM oci.compute.compute_capacity_reservation_instance_shapes
