--- 
title: dedicated_vm_host_instances
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>dedicated_vm_host_instances</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="dedicated_vm_host_instances" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="oci.compute.dedicated_vm_host_instances" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The availability domain the virtual machine instance is running in.  Example: `Uocm:PHX-AD-1` </td>
</tr>
<tr>
    <td><CopyableCode code="compartmentId" /></td>
    <td><code>string</code></td>
    <td>The OCID of the compartment that contains the virtual machine instance. </td>
</tr>
<tr>
    <td><CopyableCode code="instanceId" /></td>
    <td><code>string</code></td>
    <td>The OCID of the virtual machine instance. </td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>boolean</code></td>
    <td>Specifies whether the VM instance is confidential. </td>
</tr>
<tr>
    <td><CopyableCode code="shape" /></td>
    <td><code>string</code></td>
    <td>The shape of the VM instance. </td>
</tr>
<tr>
    <td><CopyableCode code="timeCreated" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date and time the virtual machine instance was created, in the format defined by &#91;RFC3339&#93;(https:​//tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z` </td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-compartmentId"><code>compartmentId</code></a>, <a href="#parameter-dedicatedVmHostId"><code>dedicatedVmHostId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-availabilityDomain"><code>availabilityDomain</code></a>, <a href="#parameter-isMemoryEncryptionEnabled"><code>isMemoryEncryptionEnabled</code></a>, <a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-page"><code>page</code></a>, <a href="#parameter-opc-request-id"><code>opc-request-id</code></a>, <a href="#parameter-sortBy"><code>sortBy</code></a>, <a href="#parameter-sortOrder"><code>sortOrder</code></a></td>
    <td>Returns the list of instances on the dedicated virtual machine hosts that match the specified criteria.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Returns the list of instances on the dedicated virtual machine hosts that match the specified criteria.&lt;br /&gt;
...
shape,
timeCreated
FROM oci.compute.dedicated_vm_host_instances
WHERE compartmentId = '{{ compartmentId }}' -- required
AND dedicatedVmHostId = '{{ dedicatedVmHostId }}' -- required
