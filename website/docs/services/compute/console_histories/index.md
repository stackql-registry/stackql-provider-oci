...
<tr><td><b>Id</b></td><td><CopyableCode code="oci.compute.console_histories" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The OCID of the console history metadata object.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The OCID of the instance this console history was fetched from.</td>
</tr>
<tr>
    <td><CopyableCode code="lifecycleState" /></td>
    <td><code>string</code></td>
    <td>The current state of the console history. (REQUESTED, GETTING-HISTORY, SUCCEEDED, FAILED)</td>
</tr>
<tr>
    <td><CopyableCode code="timeCreated" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date and time the history was created, in the format defined by &#91;RFC3339&#93;(https:​//tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z` </td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Shows the metadata for the specified console history.&lt;br /&gt;See &#91;CaptureConsoleHistory&#93;(#/en/iaas/latest/ConsoleHistory/CaptureConsoleHistory)&lt;br /&gt;for details about using the console history operations.&lt;br /&gt;</td>
</tr>
<tr>
    <td><a href="#list"><CopyableCode code="list" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-compartmentId"><code>compartmentId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-availabilityDomain"><code>availabilityDomain</code></a>, <a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-page"><code>page</code></a>, <a href="#parameter-instanceId"><code>instanceId</code></a>, <a href="#parameter-sortBy"><code>sortBy</code></a>, <a href="#parameter-sortOrder"><code>sortOrder</code></a>, <a href="#parameter-lifecycleState"><code>lifecycleState</code></a></td>
    <td>Lists the console history metadata for the specified compartment or instance.&lt;br /&gt;</td>
</tr>
<tr>
    ...
    <td>Updates the specified console history metadata.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-instanceConsoleHistoryId"><code>instanceConsoleHistoryId</code></a>, <a href="#parameter-region"><code>region</code></a></td>
    <td><a href="#parameter-if-match"><code>if-match</code></a></td>
    <td>Deletes the specified console history metadata and the console history data.&lt;br /&gt;</td>
</tr>
</tbody>
</table>
...
Shows the metadata for the specified console history.&lt;br /&gt;See &#91;CaptureConsoleHistory&#93;(#/en/iaas/latest/ConsoleHistory/CaptureConsoleHistory)&lt;br /&gt;for details about using the console history operations.&lt;br /&gt;
...
lifecycleState,
timeCreated
FROM oci.compute.console_histories
...
Lists the console history metadata for the specified compartment or instance.&lt;br /&gt;
...
```sql
UPDATE oci.compute.console_histories
SET 
definedTags = '{{ definedTags }}',
displayName = '{{ displayName }}',
freeformTags = '{{ freeformTags }}'
WHERE 
instanceConsoleHistoryId = '{{ instanceConsoleHistoryId }}' --required
AND region = '{{ region }}' --required
...
Deletes the specified console history metadata and the console history data.&lt;br /&gt;

```sql
DELETE FROM oci.compute.console_histories
WHERE instanceConsoleHistoryId = '{{ instanceConsoleHistoryId }}' --required
AND region = '{{ region }}' --required
AND if-match = '{{ if-match }}'
;
